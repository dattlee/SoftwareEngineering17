...
/**
 * This Class represents a Intelligent trader on the stock market that manages a Portfolio for a client on behalf of Wolf and Gecko.
 * Each Intelliegent trader created in this class is only capable of managing the affairs of one client.
 *
...
public class IntelligentTrader extends Trader {
     ...
     */
    public IntelligentTrader(String ID, TradingExchange exchange) {
        super(ID, exchange);
     ...
     */
    public IntelligentTrader(String ID, TradingExchange exchange, Portfolio portfolio) {
        super(ID, exchange);
